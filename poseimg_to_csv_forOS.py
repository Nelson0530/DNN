...
x = 1
for i in range(1, 4961):
    img = cv2.imread(f"C:/lets_dance/image/right/{i}.jpg")
    ...
    if results2.pose_landmarks:
        ...
        with open("./csvfile/featrue.csv", "a+") as q:
            write = csv.writer(q)
            write.writerow(coordinate)
